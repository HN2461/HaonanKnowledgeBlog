...
tags:
  ...
  - Vue2
  - Vue3
description: Vue2组件的生命周期可以理解为组件从创建到销毁的整个"生命旅程"，Vue为这个旅程的关键节点提供了专属的"钩子函数"。本文详解Vue2/Vue3生命周期的完整流程。
---
...
<!-- 这是一个文本绘图，源码为：graph TD
    ...
    J --> K(beforeDestroy)
    K --> L(destroyed) -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/0180dcae5365c32841fbb727da3fc04e.svg)
