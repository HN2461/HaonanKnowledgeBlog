...
作用：配置心智模型
2. [第五篇：Codex 配置字段字典与文档对照（完整版）](#/note/AI工具/Codex/第五篇_Codex配置字段字典与文档对照_完整版)
作用：字段字典和模板
3. [第六篇：Codex CLI / 插件 / App 全链路配置实战（超详细）](#/note/AI工具/Codex/第六篇_CLI插件App全链路配置实战_超详细)
作用：三端联动与排障
4. [第七篇：Codex 三端逐字段截图对照版（每一步可复现）](#/note/AI工具/Codex/第七篇_Codex三端逐字段截图对照版_每一步可复现)
作用：截图核对 SOP
5. [第十一篇：Codex 近期待补全更新总表（桌面版、IDE、云任务与 Windows 新能力）](#/note/AI工具/Codex/第十一篇_Codex近期待补全更新总表_桌面版IDE云任务与Windows新能力_2026-05-22)
作用：告诉你哪些旧认知该升级
6. **第十二篇（本篇）**
