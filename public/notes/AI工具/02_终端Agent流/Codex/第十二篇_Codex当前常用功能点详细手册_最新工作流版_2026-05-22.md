---
title: 第十二篇：Codex 当前常用功能与进阶工作流总手册（合并版）
date: 2026-05-22
category: AI工具
tags:
  - Codex
  ...
  - CLI
  - OpenAI官方
description: 合并原第二篇与第十一篇后，面向日常开发高频场景系统梳理 Codex 当前仍在官方主线中的常用功能、进阶工作流与最近该升级的认知，减少多篇重复查阅。
---

# 第十二篇：Codex 当前常用功能与进阶工作流总手册（合并版）
...
> 前置建议：第三篇先建立配置心智模型，第六篇看三端联动；原第二篇和第十一篇的有效内容已并入本篇。  
...
4. [第七篇：Codex 三端逐字段截图对照版（每一步可复现）](#/note/AI工具/02_终端Agent流/Codex/第七篇_Codex三端逐字段截图对照版_每一步可复现)  
   负责界面对照 SOP。
5. [第四篇：Codex 多线路接入与迁移总手册](#/note/AI工具/02_终端Agent流/Codex/第四篇_Codex多来源完整配置手册_小白友好版)  
   负责官方、Packy、yunyi、rpcod 等线路选择与迁移。
6. **第十二篇（本篇）**  
   负责当前常用功能、官方进阶能力和最近该升级的产品认知。

原第二篇和第十一篇已经并入本篇，不再作为主线推荐单独阅读。
