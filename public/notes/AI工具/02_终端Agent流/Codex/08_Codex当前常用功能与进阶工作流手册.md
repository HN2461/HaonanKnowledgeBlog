---
title: 第八篇：Codex 当前常用功能与进阶工作流手册
date: 2026-05-22
category: AI工具
tags:
  - Codex
  ...
  - CLI
  - OpenAI官方
description: 面向日常开发高频场景系统梳理 Codex 当前仍在主线中的常用功能、进阶工作流与最近该升级的认知，减少多篇重复查阅。
---

# 第八篇：Codex 当前常用功能与进阶工作流手册
...
> 前置建议：第三篇先建立配置心智模型，第六篇看三端联动；官方进阶、桌面端和 IDE 新能力统一在本篇维护。  
...
1. [第三篇：Codex 配置心智模型](#/note/AI工具/02_终端Agent流/Codex/03_Codex配置心智模型)  
   负责配置心智模型。
2. [第五篇：Codex 配置字段字典](#/note/AI工具/02_终端Agent流/Codex/05_Codex配置字段字典)  
   负责字段字典和模板。
3. [第六篇：Codex CLI / 插件 / App 三端联动实战](#/note/AI工具/02_终端Agent流/Codex/06_Codex_CLI插件App三端联动实战)  
   负责三端联动与排障。
4. [第四篇：Codex 多线路接入与迁移总手册](#/note/AI工具/02_终端Agent流/Codex/04_Codex多线路接入与迁移总手册)  
   负责官方、Packy、yunyi、rpcod 等线路选择与迁移。
5. [第七篇：Codex 命令与配置文件速查](#/note/AI工具/02_终端Agent流/Codex/07_Codex命令与配置文件速查)  
   负责命令、配置文件和 slash command 速查。
6. [第九篇：Codex / CCSwitch 本机配置重构实战（HN246 版）](#/note/AI工具/02_终端Agent流/Codex/09_Codex_CCSwitch本机配置重构实战_HN246版)  
   负责 HN246 本机 `config.toml`、CCSwitch 配置和跨机路径排查。
7. **第八篇（本篇）**  
