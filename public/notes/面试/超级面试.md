...
tags:
  ...
  - Vue
  - 面试题汇总
description: 前端开发超级面试题汇总，包含 let/const/var、闭包、内存泄漏等核心面试题详解。
---
...
+ 主要是通过过**Object.defineProperty来实现的，**通过**Object.defineProperty来劫持对象属性的setter和getter操作**，并**“种下”一个监听器**，当数据发生变化的时候发出通知。
