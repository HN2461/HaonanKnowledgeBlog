...
tags:
  ...
  - 分页搜索
  - 软删除
description: 用 Express + MongoDB + Mongoose 搭建一个真正适合练手和扩展的笔记 API 项目，把建模、鉴权、索引、分页、搜索和软删除组织成完整工程。
---
