---
title: uni-app 迁移钉钉时最容易搞混的各种 ID：corpId、agentId、miniAppId、clientId、userId、unionId、openid
date: 2026-03-31
category: uni-app
tags:
  - uni-app
  ...
  - 企业应用
  - 迁移踩坑
description: 梳理 uni-app 从微信迁移到钉钉时最容易混淆的 corpId、agentId、miniAppId、clientId、userId、unionId、openid、authCode 与 access_token，明确它们的层级、用途与取舍。
---

# uni-app 迁移钉钉时最容易搞混的各种 ID：corpId、agentId、miniAppId、clientId、userId、unionId、openid
