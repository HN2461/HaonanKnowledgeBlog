---
title: uni-app STOMP 帧封装实战：命令拼装、拆帧、心跳与粘包处理
date: 2026-04-16
category: 项目复用技术
tags:
  - uni-app
  ...
  - 粘包处理
  - 心跳
description: 这是 WebSocket 专题的第 2 篇，专门讲 STOMP 帧层应该怎么封，包括命令常量、帧拼装、CONNECT/SUBSCRIBE 帧构建、心跳帧、单帧解析以及多帧拆包与 remainder 处理。
---

# uni-app STOMP 帧封装实战：命令拼装、拆帧、心跳与粘包处理

> 这是 `项目复用技术 / uni-app / WebSocket` 专题的第 2 篇。  
...
`STOMP 帧层最值得沉淀的，不是某个命令，而是“统一构帧 + 统一拆帧 + 心跳处理 + 粘包 remainder 机制”这四件事。`
