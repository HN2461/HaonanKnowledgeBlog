...
describe('noteOrder', () => {
  ...
  it('sorts same-date notes by filename sequence when newest first', () => {
    const notes = [
      { filename: '03-api.md', date: '2026-03-31' },
      { filename: '01-basics.md', date: '2026-03-31' },
      { filename: '02-structure.md', date: '2026-03-31' }
    ]
  ...
  it('sorts notes by filename sequence regardless of date', () => {
    const notes = [
      { filename: '08-handbook.md', date: '2026-04-02' },
      { filename: '02-structure.md', date: '2026-03-31' },
      { filename: '01-basics.md', date: '2026-03-30' }
    ]
  ...
  it('sorts by date asc and keeps sequence order for ties', () => {
    const notes = [
      { filename: '02-structure.md', date: '2026-03-31' },
      { filename: '01-basics.md', date: '2026-03-31' },
      { filename: '06-stability.md', date: '2026-04-01' }
    ]
  ...
  it('removes sequence prefixes from titles before comparison', () => {
    ...
    expect(stripLeadingSequencePrefix('第3篇 API 实战')).toBe('API 实战')
  })
})
